        ...
        <section id="portfolio" className="py-20 bg-[var(--bg-card)]">
            <div className="container">
                ...
                <div className="text-center mt-12">
                    <a href="https://wa.me/918281808385?text=Hello!%20I%20saw%20your%20Portfolio%20projects%20and%20want%20to%20know%20more." target="_blank" className="btn btn-outline px-8">View More on WhatsApp</a>
                </div>
            </div>
        </section>
    );
